...
import 'package:eshop_multivendor/Screen/CurrentOrders.dart';
...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  TextEditingController mobilelController = TextEditingController();
  ...
  Future<void> setUpdateUser(String userID,
    ...
    if (!error) {
      ...
      if ((username != "") && (userEmail != "")) {
        ...
        userProvider.setEmail(userMobile);
      }
  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        CUR_USERID == "" || CUR_USERID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'CURRENT_ORDER')!,
            'assets/images/pro_myorder.svg'),
        ...
        // CUR_USERID == "" || CUR_USERID == null
        //     ? Container()
        //     : _getDrawerItem(getTranslated(context, 'SCANQR')!,
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          //       ));
          // }
          // else if (title == getTranslated(context, 'SCANQR')) {
          //   Navigator.push(
          //       context,
          //       MaterialPageRoute(
          ...
          //       ));
          //}
          else if (title == getTranslated(context, 'CURRENT_ORDER')) {
            Navigator.push(
                context,
                MaterialPageRoute(
    ...
    if (form.validate()) {
      if (key == _changePwdKey) {
        await setUpdateUser(CUR_USERID!, passwordController.text,
            newpassController.text, nameController.text,emailController.text,mobilelController.text);
        ...
        setUpdateUser(
            CUR_USERID!, "", "", nameController.text, emailController.text,mobilelController.text);
      }
      return true;
    }
    return false;
