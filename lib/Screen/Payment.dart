...
//                                               itemBuilder: (context, index){
//                                                 if (index == 1 && cod&& prefs!.getBool('isTakeAway') == false )
                            ...
                            //     userProvider.curBalance != ""
                              ...
                              child: CheckboxListTile(
                                ...
                                onChanged: (bool? value) {
                                        ...
                                        if (totalPrice <=
                                          ...
                                          remWalBal = (double.parse(
                                              userProvider
                                                  .curBalance) -
                                              totalPrice);
                                          print("current balance ${userProvider.curBalance}");
                                          usedBal = totalPrice;
                                          payMethod = "Wallet";
                                  ...
                                  print("checking price ${totalPrice}");
                                },
                                title: Text(
                                  getTranslated(
                                      context, 'USE_WALLET')!,
                                ...
                                subtitle: Padding(
                                  ...
                                  Text(
                                    isUseWallet!
                                        ...
                                        remWalBal.toString()
                                        : userProvider
                                        .curBalance.toString()!="null" || userProvider.curBalance != null ||  userProvider.curBalance.toString() != ""  ?getTranslated(context,
                                        'TOTAL_BAL')! +
                                        " : " +
                                        CUR_CURRENCY! +
                                        " "
