...
class _HomePageState extends State<HomePage>
  ...
  Future<Null> _refresh() async{
   await  context.read<HomeProvider>().setCatLoading(true);
    await context.read<HomeProvider>().setSecLoading(true);
    await context.read<HomeProvider>().setSliderLoading(true);
    await getSeller();
    return callApi();
  }
                          ...
                          return Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                ...
                                //                   .store_description,
                                //             )));
                                print("seller id here ${sellerList[index].seller_id}");
                                if(sellerList[index].open_close_status == "1"){
                                  // Navigator.push(
                                  //     context,
                                  //     MaterialPageRoute(
                                  //         builder: (context) => SubCategory(
                                  //           storeQR: sellerList[index].qrCode,
                                  ...
                                  //           storerating: sellerList[index].noOfRating,
                                  //           foodPerson: sellerList[index].food_person,
                                  //           estimatedTime: sellerList[index].estimated_time,
                                  ...
                                  //         )));
                                  print("this is seller ID @@ ${sellerList[index].seller_id}");

                                  Navigator.push(context, MaterialPageRoute(builder: (context) =>
                                      SellerProfile(sellerName: sellerList[index].seller_name,
                                        sellerID: sellerList[index].seller_id,
                                        sellerData: sellerList[index],
                                        todaySpecial: sellerList[index].todaySpecial,
                                        todayCategory: sellerList[index].today_category,
                                        title: sellerList[index].store_name,
                                        address: sellerList[index].address,
                                        sellerStoreName: sellerList[index].store_name,
                                        search: true, storeDesc: sellerList[index].store_description,sellerRating: sellerList[index].seller_rating,storerating: sellerList[index].noOfRating,
                                        foodPerson: sellerList[index].food_person,estimatedTime: sellerList[index].estimated_time,storeQR: sellerList[index].qrCode,
                                      )));
                                            ...
                                            child: Column(
                                              children: [
                                                ListTile(
                                                  ...
                                                  trailing: sellerList[index].open_close_status == "1"
                                                      ? Text("Open",
                                                    style: TextStyle(
                                                        color: Colors.green
                                                    ),
