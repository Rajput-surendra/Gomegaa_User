...
class _LoginPageState extends State<Login> with TickerProviderStateMixin {
  ...
  final passwordController = TextEditingController();
    TextEditingController mobileC = new TextEditingController();
  String? countryName;
  ...
  socialLoginApi()async{
    ...
    var request = http.MultipartRequest('POST', Uri.parse(baseUrl + 'social_login'));
    ...
    if (response.statusCode == 200) {
      ...
      print("checking result ${jsonResponse.data![0].id} and ${jsonResponse.data![0].username}");
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Text("Login With Google",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w500),),
                        ),
                      ),
                      SizedBox(
                        height: MediaQuery.of(context).size.height * 0.10,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  child: TextField(
                                    maxLength: 10,
                                   // keyboardType: InputType.PhoneNumber
                                    controller: mobileC,
                                    keyboardType: TextInputType.number,
                                    // style:
